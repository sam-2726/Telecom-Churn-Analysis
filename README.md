...
This project analyzes customer churn behavior in a telecom company using Excel, SQL, Python (Pandas), and Power BI.
The objective is to identify the key factors influencing customer churn and provide data-driven insights to help reduce customer loss and improve retention strategies.

🎯 Project Objective

Customer churn is a major challenge in the telecom industry due to high competition and customer switching behavior.
...
This analysis helps telecom businesses understand customer behavior, reduce churn risk, and improve long-term customer retention through data-driven decision making.
